...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VolunteerOpportunityResource'
        db.create_table(u'mnch_volunteeropportunityresource', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='volunteeropportunityresource_created', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='volunteeropportunityresource_updated', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('position', self.gf('django.db.models.fields.PositiveIntegerField')(default=99)),
            ('opportunity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mnch.VolunteerOpportunity'])),
        ))
        db.send_create_signal(u'mnch', ['VolunteerOpportunityResource'])


    def backwards(self, orm):
        # Deleting model 'VolunteerOpportunityResource'
        db.delete_table(u'mnch_volunteeropportunityresource')
    ...
    models = {
        ...
        u'mnch.volunteeropportunityresource': {
            'Meta': {'ordering': "('position', 'name')", 'object_name': 'VolunteerOpportunityResource'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'volunteeropportunityresource_created'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'db_index': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'opportunity': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mnch.VolunteerOpportunity']"}),
            'position': ('django.db.models.fields.PositiveIntegerField', [], {'default': '99'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'volunteeropportunityresource_updated'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            'url': ('django.db.models.fields.URLField', [], {'max_length': '200'})
        }
    }
